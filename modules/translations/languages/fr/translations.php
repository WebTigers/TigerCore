...
return [
    ...
    'translations.subtitle'           => 'Recherchez, modifiez et remplacez n’importe quel texte de l’interface par langue — sans redéploiement.',
    ...
    'translations.source_note'        => 'Les textes source sont affichés en %s.',
    ...
    'translations.uses_file'        => 'Utilise la valeur par défaut',
    'translations.revert_all'       => 'Rétablir les valeurs par défaut',
    'translations.cancel'           => 'Annuler',
    'translations.save'             => 'Enregistrer',
    'translations.no_refs'          => 'Aucune référence directe trouvée dans le code — peut être utilisée dynamiquement.',
    'translations.revert_confirm'   => 'Rétablir la valeur par défaut ?',

    'translations.saved_toast'    => 'Traductions enregistrées.',
    'translations.reverted_toast' => 'Rétabli à la valeur par défaut.',
    'translations.net_error'      => 'Erreur réseau — veuillez réessayer.',

    'translations.saved'            => 'Traductions enregistrées.',
    'translations.reverted'         => 'Rétabli à la valeur par défaut.',
    'translations.error.no_key'     => 'Aucune clé de traduction fournie.',
    ...
    'translations.error.ai_failed'  => 'La traduction par IA n’a pas pu aboutir. Veuillez réessayer.',
