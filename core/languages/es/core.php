...
return [
    ...
    'core.nav.account' => 'Mi cuenta',
    'core.nav.content' => 'Contenido',
    'core.nav.articles' => 'Artículos',
    'core.nav.menus' => 'Menús',
    'core.nav.media' => 'Medios',
    'core.nav.users' => 'Usuarios',
    'core.nav.orgs' => 'Organizaciones',
    'core.nav.code' => 'Código',
    'core.nav.modules' => 'Módulos',
    'core.nav.settings' => 'Configuración',
    ...
    'core.datatable.info_filtered' => '(filtrado de _MAX_ registros totales)',
    'core.datatable.length_menu' => '_MENU_ por página',
    'core.datatable.search_placeholder' => 'Buscar…',
    'core.datatable.zero_records' => 'No se encontraron registros coincidentes',
    'core.datatable.empty_table' => 'No hay datos disponibles',
    'core.datatable.loading' => 'Cargando…',
    'core.datatable.processing' => 'Procesando…',
    'core.datatable.paginate_first' => 'Primero',
    'core.datatable.paginate_last' => 'Último',
    'core.datatable.paginate_next' => 'Siguiente',
    'core.datatable.paginate_prev' => 'Anterior',
    'core.nav.modules_manage' => 'Gestionar',

    // Media picker field (Tiger_View_Helper_MediaField) — shared by the Identity, CMS and SEO screens.
    'core.media.field.choose'          => 'Elegir medio',
