...
return [
    ...
    'core.nav.account' => 'My Account',
    'core.nav.content' => 'Content',
    'core.nav.articles' => 'Articles',
    'core.nav.menus' => 'Menus',
    'core.nav.media' => 'Media',
    'core.nav.users' => 'Users',
    'core.nav.orgs' => 'Organizations',
    'core.nav.code' => 'Code',
    'core.nav.modules' => 'Modules',
    'core.nav.settings' => 'Settings',
    'core.datatable.info' => 'Showing _START_ to _END_ of _TOTAL_ entries',
    'core.datatable.info_empty' => 'Showing 0 to 0 of 0 entries',
    'core.datatable.info_filtered' => '(filtered from _MAX_ total entries)',
    'core.datatable.length_menu' => '_MENU_ per page',
    'core.datatable.search_placeholder' => 'Search…',
    'core.datatable.zero_records' => 'No matching records found',
    'core.datatable.empty_table' => 'No data available',
    'core.datatable.loading' => 'Loading…',
    'core.datatable.processing' => 'Processing…',
    'core.datatable.paginate_first' => 'First',
    'core.datatable.paginate_last' => 'Last',
    'core.datatable.paginate_next' => 'Next',
    'core.datatable.paginate_prev' => 'Previous',
    'core.nav.modules_manage' => 'Manage',

    // Media picker field (Tiger_View_Helper_MediaField) — shared by the Identity, CMS and SEO screens.
    'core.media.field.choose'          => 'Choose media',
